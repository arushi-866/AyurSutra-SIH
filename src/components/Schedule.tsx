        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-xl p-6 w-full max-w-2xl max-h-[90vh] overflow-y-auto">
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
              <h4 className="text-sm font-medium text-blue-900 mb-2">Smart Scheduling Features</h4>
              <ul className="text-sm text-blue-700 space-y-1">
                <li>• Automatic conflict detection and resolution</li>
                <li>• Practitioner availability optimization</li>
                <li>• Buffer time management between sessions</li>
                <li>• Automated pre/post-procedure notifications</li>
              </ul>
            </div>
